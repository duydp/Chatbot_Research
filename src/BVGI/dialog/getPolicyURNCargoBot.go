...
type GetPolicyURNCargoBot struct {
	fbbot.BaseStep
}
func (s GetPolicyURNCargoBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
	bot.SendText(msg.Sender, util.Personalize(T("getSoHopDong_title"), &msg.Sender))
	return StayEvent
}

func (s GetPolicyURNCargoBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
