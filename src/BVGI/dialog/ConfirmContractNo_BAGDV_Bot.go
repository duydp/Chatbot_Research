...
type ConfirmContractNoBAGDVBot struct {
	fbbot.BaseStep
}

func (s ConfirmContractNoBAGDVBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmContractNoBAGDVBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
