...
type ConfirmPolicyHolderIDFireBot struct {
	fbbot.BaseStep
}

func (s ConfirmPolicyHolderIDFireBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmPolicyHolderIDFireBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
