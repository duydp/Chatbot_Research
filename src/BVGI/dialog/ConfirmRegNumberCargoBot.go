...
type ConfirmRegNumberCargoBot struct {
	fbbot.BaseStep
}

func (s ConfirmRegNumberCargoBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmRegNumberCargoBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
