...
type ConfirmChassisNoBot struct {
	fbbot.BaseStep
}
func (s ConfirmChassisNoBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmChassisNoBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
