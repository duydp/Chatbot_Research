...
type ConfirmPolicyHolderNameFireBot struct {
	fbbot.BaseStep
}

func (s ConfirmPolicyHolderNameFireBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmPolicyHolderNameFireBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
