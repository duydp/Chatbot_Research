...
type ConfirmVesselNameBot struct {
	fbbot.BaseStep
}

func (s ConfirmVesselNameBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmVesselNameBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
