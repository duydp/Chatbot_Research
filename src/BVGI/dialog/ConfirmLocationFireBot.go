...
type ConfirmLocationFireBot struct {
	fbbot.BaseStep
}

func (s ConfirmLocationFireBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmLocationFireBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
