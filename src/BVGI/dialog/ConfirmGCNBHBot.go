...
type ConfirmGCNBHBot struct {
	fbbot.BaseStep
}

func (s ConfirmGCNBHBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmGCNBHBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
