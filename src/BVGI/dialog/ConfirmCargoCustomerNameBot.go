...
type ConfirmCargoCustomerNameBot struct {
	fbbot.BaseStep
}

func (s ConfirmCargoCustomerNameBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmCargoCustomerNameBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
