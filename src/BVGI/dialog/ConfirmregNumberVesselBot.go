...
type ConfirmRegNumberVesselBot struct {
	fbbot.BaseStep
}

func (s ConfirmRegNumberVesselBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmRegNumberVesselBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
