...
type ConfirmCargoNameBot struct {
	fbbot.BaseStep
}

func (s ConfirmCargoNameBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmCargoNameBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
