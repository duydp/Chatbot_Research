...
type GetPolicyHolderIDFireBot struct {
	fbbot.BaseStep
}
func (s GetPolicyHolderIDFireBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
	bot.SendText(msg.Sender, util.Personalize(T("getCMTND_title"), &msg.Sender))
	return StayEvent
}
func (s GetPolicyHolderIDFireBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
	...
	//}
	result, _ :=  soap.GetpolicyHolderIDFireInfo(policyHolderID_Fire)
