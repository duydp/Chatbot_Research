...
type ConfirmCMNDCommonBot struct {
	fbbot.BaseStep
}

func (s ConfirmCMNDCommonBot) Enter(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
...
func (s ConfirmCMNDCommonBot) Process(bot *fbbot.Bot, msg *fbbot.Message) fbbot.Event {
